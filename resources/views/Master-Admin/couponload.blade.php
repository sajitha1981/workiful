            ...
            <thead class="cf">
              <tr>
                ...
                <th class="numeric" style="background:#03314b;color:#ffffff">No.</th>
				 <th style="background:#03314b;color:#ffffff">Coupon Code</th>
                 <th style="background:#03314b;color:#ffffff">Start Date </th>
                <th style="background:#03314b;color:#ffffff">End Date </th>
                <th style="background:#03314b;color:#ffffff">Discount Type </th>
...
<?php $index = $stcnt; ?>
			@if (count($eduList) > 0)
              ...
              <tr>
                <!-- All actions td start -->
                <td data-title="All"><input name="del[]" type="checkbox" value="{{ $val->coupon_id }}"  /></td>
                <!-- /All actions td -->
                <td data-title="No">{{ $index }}</td>
				<td data-title="Coupon Code"> {{ $val->coupon_code }}</td>
                <td data-title="Coupon Code"> {{ date("m/d/Y",strtotime($val->start_date)) }}</td>
				<td data-title="Coupon Code"> {{ date("m/d/Y",strtotime($val->end_date)) }}</td>
                ...
                <td data-title="Actions">
                  ...
                  <div class="btn-group dropup">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="#"><i class="fa fa-edit"></i> Edit Code</a></li>
                      <li><a href="#" class="delete-record" data-value="{{ $val->coupon_id }}"><i class="fa fa-trash"></i> Delete Record</a></li>
                    </ul>
                  </div>
                  <!-- /Actions html -->
                </td>
              ...
              <!-- /Data Row -->
               @endforeach
			@else
				<tr align='center' valign='middle'><td class='' colspan='5'>No coupon found.</td></tr>   
			@endif
</div>
 </tbody>
          </table>
