<table class="col-md-12 table-bordered table-striped table-condensed cf table-hover">
            <thead class="cf">
              <tr>
                ...
                <th style="background:#03314b;color:#ffffff">Education</th>
...
<?php $index = $stcnt; ?>
			@if (count($eduList) > 0)
              ...
              <tr>
                <!-- All actions td start -->
                <td data-title="All"><input name="del[]" type="checkbox" value="{{ $val->education_id }}"  /></td>
                <!-- /All actions td -->
                <td data-title="No">{{ $index }}</td>
                <td data-title="Education"> {{ $val->education_name }}</td>
                <td data-title="Status">
					@if ($val->education_status == 1)
						Active
					@else 
						Inactive
					@endif
                ...
                <td data-title="Actions">
                  ...
                  <div class="btn-group dropup">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="#"><i class="fa fa-edit"></i> Edit Education</a></li>
                      <li><a href="#" class="delete-record" data-value="{{ $val->education_id }}"><i class="fa fa-trash"></i> Delete Record</a></li>
                    </ul>
                  </div>
                  <!-- /Actions html -->
                </td>
              ...
              <!-- /Data Row -->
               @endforeach
			@else
				<tr align='center' valign='middle'><td class='' colspan='5'>No education found.</td></tr>   
			@endif
</div>
 </tbody>
          </table>
