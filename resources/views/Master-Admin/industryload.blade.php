            ...
            <thead class="cf">
              <tr>
                ...
                <th class="numeric" style="background:#03314b;color:#ffffff">No.</th>
				 <th style="background:#03314b;color:#ffffff">Industry</th>
...
<?php $index = $stcnt; ?>
			@if (count($eduList) > 0)
              ...
              <tr>
                <!-- All actions td start -->
                <td data-title="All"><input name="del[]" type="checkbox" value="{{ $val->industry_id }}"  /></td>
                <!-- /All actions td -->
                <td data-title="No">{{ $index }}</td>
				 <td data-title="Industry"> {{ $val->industry_name }}</td>
                
                <td data-title="Status">
					@if ($val->industry_status == 1)
						Active
					@else 
						Inactive
					@endif
                ...
                <td data-title="Actions">
                  ...
                  <div class="btn-group dropup">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      <li><a href="#"><i class="fa fa-edit"></i> Edit Industry</a></li>
                      <li><a href="#" class="delete-record" data-value="{{ $val->industry_id }}"><i class="fa fa-trash"></i> Delete Record</a></li>
                    </ul>
                  </div>
                  <!-- /Actions html -->
                </td>
              ...
              <!-- /Data Row -->
               @endforeach
			@else
				<tr align='center' valign='middle'><td class='' colspan='5'>No industry found.</td></tr>   
			@endif
</div>
 </tbody>
          </table>
