      ...
      <div class="row">
        ...
        <div class="col-md-8 col-sm-8 col-lg-8">
          <div class="hedging-common">
            <h3><b>Razeqeen:</b><span style="color:#009898"> City</span>  </h3>
            <p><span><b>Today Is:</b></span> {{date("l, d  F Y")}}</p>
            <p>Total:<span class="only-size"><b id="rdCnt"> {{ $eduCnt }} </b></span> Citie(s)</p>
          </div>
        </div>
        ...
        <div class="col-md-4 col-sm-4 col-lg-4">
          <div class="hedging text-right">
            <h3><span>CEO:</span> {{session('sesAdminautoID')}}</h3>
			 <a href="add-edit-city" class="btn btn-secondary"><i class="glyphicon glyphicon-user"></i><b>+ Add  City</b></a>
          </div>
        </div>
      </div>
      ...
      <div class="btn-group" role="group" aria-label="...">
        ...
        <div class="btn-group" role="group">
          ...
          <ul class="dropdown-menu " role="menu">
            <li><a class="numrecs" href="list-cities?npage=10" data-value="10"><i class="fa fa-list-ol"></i> Show 10 Records</a></li>
            <li><a class="numrecs" href="list-cities?npage=25" data-value="25"><i class="fa fa-list-ol"></i> Show 25 Records</a></li>
            <li><a class="numrecs" href="list-cities?npage=50" data-value="50"><i class="fa fa-list-ol"></i> Show 50 Records</a></li>
            <li><a class="numrecs" href="list-cities?npage=100" data-value="100"><i class="fa fa-list-ol"></i> Show 100 Records</a></li>
            <div class="div"></div>
            <li><a class="sorder"  data-value="ASC"  href="list-cities?orderby=ASC"><i class="fa fa-long-arrow-up"></i> Ascending Order</a></li>
            <li><a class="sorder" data-value="DESC" href="list-cities?orderby=DESC"><i class="fa fa-long-arrow-down"></i> Descending Order</a></li>
          </ul>
        </div>
      </div>
    </div>
