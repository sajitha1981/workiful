...
<?php $index = $stcnt; ?>
			@if (count($eduList) > 0)
                ...
                <td data-title="Actions">
                  ...
                  <div class="btn-group dropup">
                    ...
                    <ul class="dropdown-menu pull-right" role="menu">
                      ...
                      <li><a href="#" class="delete-record" data-value="{{ $val->state_id }}"><i class="fa fa-trash"></i> Delete Record</a></li>
                    </ul>
                  </div>
                  <!-- /Actions html -->
                </td>
              ...
              <!-- /Data Row -->
               @endforeach
			@else
				<tr align='center' valign='middle'><td class='' colspan='5'>No state found.</td></tr>   
			@endif
</div>
 </tbody>
          </table>
